...
struct BrandView: View {
    ...
    var body: some View {
        ScrollView{
            ...
            VStack {
                Text("* \"Веганский продукт\" - продукция не содержит ингредиенты животного происхождения\n* \"Не тестируется на животных\" - значит, что ни на одном из этапов производства ни сам продукт, ни его ингредиенты не были протестированы на животных, а также продукция бренда не продаётся в странах, где тестирование продукции на животных обязательно")
